                        ...
                        <div class="bs-example4" data-example-id="contextual-table">
                            <table class="table">
								...
								while ($rows = mysqli_fetch_assoc($result)) {
									...
									$albom_id = $rows['albom_id'];
									$qqqq = "SELECT fullname FROM artist WHERE id = '$artist_id'";
									$wwww = "SELECT fullname FROM alboms WHERE id = '$albom_id'";
									$rrrr = mysqli_query($conn, $qqqq);
									$aaaa = mysqli_query($conn, $wwww);
									$artistname = "";
									$albomname = "";
									while ($rw1 = mysqli_fetch_assoc($rrrr)){
										$artistname = $rw1['fullname'];
									}
									while ($rw2 = mysqli_fetch_assoc($aaaa)) {
										$albomname = $rw2['fullname'];
									}
							?>
                                    <tr class="active">
