				...
				<li>
					...
					<li>
                        ...
                        <ul class="nav nav-second-level">
							...
							<li><a href="addalbom.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>Add Albom</a></li>
					   </ul>
                    </li>
                    <!-- <li>
            ...
            <div class="content-main">
                ...
                <div class="blank">
                    ...
                    <!-- <div class="registration-form"> -->
                        ...
                        <form action="artistadd.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="contact" placeholder="+992-92-640-54-55 (without symbol)"
                                    name="contact" required>
                            </div>

                            <div class="form-group">
                                <label for="addd">Add his Image</label>
                                <input type="file" name="fileToUpload" id="addd">
                            </div>
