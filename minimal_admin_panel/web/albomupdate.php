                    ...
                    <form action="" method="post">
                        <?php
                            ...
                            while ($row = mysqli_fetch_assoc($res)) {
                                $fname = $row['fullname'];
                                $executorId = $row['artist_id'];
                                $doc = $row['create_date'];
                                $query = "SELECT fullname FROM artist WHERE id = '$executorId'";
                                $executorname = "";
                                $rrr = mysqli_query($conn, $query);
                                while ($rows = mysqli_fetch_assoc($rrr)) {
                                    $executorname = $rows['fullname'];
                                }
                        ?>
                        ...
                        <div class="form-group">
                            <label for="dob">Date of creation:</label>
                            <input type="date" id="doc" name="doc" value="<?=$doc?>">
                        </div>
